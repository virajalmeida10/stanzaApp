...
import com.almeida.viraj01.projects.stanzaApp.entity.*;
import com.almeida.viraj01.projects.stanzaApp.entity.enums.BookingStatus;
import com.almeida.viraj01.projects.stanzaApp.exception.ResourceNotFoundException;
import com.almeida.viraj01.projects.stanzaApp.exception.UnAuthorisedException;
import com.almeida.viraj01.projects.stanzaApp.repository.*;
import com.almeida.viraj01.projects.stanzaApp.strategy.PricingService;
...
public class BookingServiceImpl implements BookingService{
    ...
    public BookingDto addGuests(Long bookingId, List<Long> guestIdList) {
        ...
        if (booking.getBookingStatus() != BookingStatus.RESERVED
            ...
            throw new IllegalStateException("This booking can no longer be paid (status: " + booking.getBookingStatus() + ")");
        }
