...
import com.almeida.viraj01.projects.stanzaApp.dto.RoomPriceDto;
...
public interface InventoryRepository extends JpaRepository<Inventory, Long> {
    ...
    // Half-open range [startDate, endDate): the check-out day is NOT a booked night.
    @Query("""
            SELECT i
            FROM Inventory i
    ...
    // Release a still-reserved (unpaid) hold so the room becomes available again.
    @Modifying
    @Query("""
                UPDATE Inventory i
                SET i.reservedCount = i.reservedCount - :numberOfRooms
    ...
    @Query("""
       SELECT new com.almeida.viraj01.projects.stanzaApp.dto.RoomPriceDto(
            i.room,
            CASE
